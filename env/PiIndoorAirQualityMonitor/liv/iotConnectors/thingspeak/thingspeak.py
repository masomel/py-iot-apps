...
if __name__ == "__main__":
  ...
  ts_conn    = http.client.HTTPConnection("api.thingspeak.com:80")
...
while (1):
  ...
  ts_params = urllib.parse.urlencode({'field1': data['CO2level'], 'field2': data['Temperature'], 'field3': data['Humidity'], 'field4': data['AirPressure'], 'key': apiKey})
